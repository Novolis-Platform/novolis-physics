...
/// <summary>Builds a <see cref="BvhStaticWorld"/> from a 2D wall grid (XZ plane, +Y up).</summary>
public static class RoomMeshBuilder
{
    /// <summary>
    /// Creates collision geometry for each non-zero cell in row-major <paramref name="cells"/>.
    /// </summary>
